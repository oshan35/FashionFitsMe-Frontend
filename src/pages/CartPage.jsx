...
//         subTotal: 100, // Example values, replace with your actual data
//         discount: 10,
//         estimatedTotal: 90
...
// //         <div class="bg-grey-500   gap-14">
// //             <CartItemCard itemName={"'O The Rise Ribbed WW Top"} itemPrice={"3750"} color={"Purple"} size={"UK10"} quantity={4}/>
// //             <CartItemCard itemName={"'O The Rise Ribbed WW Top"} itemPrice={"3750"} color={"Purple"} size={"UK10"} quantity={4}/>
// //             <CartItemCard itemName={"'O The Rise Ribbed WW Top"} itemPrice={"3750"} color={"Purple"} size={"UK10"} quantity={4}/>
// //             <CartItemCard itemName={"'O The Rise Ribbed WW Top"} itemPrice={"3750"} color={"Purple"} size={"UK10"} quantity={4}/>
// //             <CartItemCard itemName={"'O The Rise Ribbed WW Top"} itemPrice={"3750"} color={"Purple"} size={"UK10"} quantity={4}/>
...
// //     </div>
// //     <OrderSummary clas="h-auto w-auto"  orderInformation={orderInformation}/>
// // </div>
// <div className="mt-10 flex flex-col xl:flex-row jusitfy-center items-stretch  w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">

// <div className="flex flex-col justify-start items-start bg-gray-50 px-4 py-4 md:py-6 md:p-6 xl:p-8 w-1500">
    ...
    return (
        <div className="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
            ...
            <div className="mt-10 flex flex-col xl:flex-row jusitfy-center items-stretch  w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
                ...
                <div className="bg-gray-50 w-auto flex justify-between items-center md:items-start px-4 py-6 md:p-6 xl:p-8 flex-col ">
